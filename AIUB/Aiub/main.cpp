...
void startscreen(void)
{
    ...
    glColor3f(1,1,1);
    drawstring(100,370,0.0,"Mehedi Hasan Joy              (18-38413-2)");
    drawstring(100,290,0.0,"Md Sakib Shahriar Tanoy   (18-37751-1)");
    drawstring(100,210,0.0,"Miraj,MD Ajharul Islam      (18-37165-1)");
